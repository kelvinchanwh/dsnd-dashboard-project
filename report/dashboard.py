...
class LineChart(MatplotlibViz):
    ...
    def visualization(self, entity_id, model):
        ...
        counts = model.event_counts(entity_id)
        ...
        counts = counts.set_index("event_date")
        ...
        ax.set_title("Engagement Events Over Time")
        ax.set_xlabel("Date")
        ax.set_ylabel("Count")
...
class BarChart(MatplotlibViz):
    ...
    def visualization(self, entity_id, model):
        ...
        # pass the `asset_id` to the `.model_data` method to
        # receive the data that can be passed to the machine
        # learning model
